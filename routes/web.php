...
Route::get('/sePerson', function () {
    $peoples= DB::table('people')->select('id','etternavn','fornavn','created_by','parent1','parent2','dato_fodt','dato_dod','fodested','sted_dod','barn','created_at')->get()->sortBy('etternavn');
